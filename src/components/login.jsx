                                        ...
                                        <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                            ...
                                            <form className="mx-1 mx-md-4 mt-5" onSubmit={handleSubmit}>
                                                ...
                                                <div className="d-flex flex-row align-items-center mb-2">
                                                    ...
                                                    <div className="form-outline flex-fill mb-0">
                                                        <input type={showpassword ? "text" : "password"} name="password" className="form-control d-inline border-top-0 border-left-0 border-right-0" placeholder="password" onChange={(e) => { dataentry(e) }} required />
