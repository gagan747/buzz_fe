...
import { forgotPasswordUrl, forgotPasswordOtpGeneratorUrl } from '../config';
...
export default function Forgotpassword() {
  ...
  const handleSend = async () => {
    try {
      ...
      setLoading(true);
      const response = await fetch(forgotPasswordOtpGeneratorUrl, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
              ...
              <div className="card-body p-md-5">
                <div className="row justify-content-center">
                  <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                    <p className="text-center h2 fw-bold  mx-1 mx-md-5 mb-5 pb-5">
                      Password Assistance
                    </p>
                    <form className="mx-1 mx-md-4 mt-5" onSubmit={handleSubmit}>
                      ...
                      <div className="d-flex flex-row align-items-center mb-2">
                        <i
                          className={
                            loading
                              ? 'fa fa-spinner fa-spin fa-lg me-sm-3 me-l-3 me-xl-0 fa-fw'
                              : 'fa fa-circle fa-lg me-3 fa-fw'
                          }
                        />
                        <div className="col-10 form-outline flex-fill mb-0">
                          <input
                            name="otp"
                            type="text"
                            className="form-control  ml-xl-0 border-top-0 border-left-0 border-right-0"
                            placeholder="OTP"
                            onChange={(e) => {
                              formdata(e);
                            }}
                      ...
                      <div
                        style={{ margin: '50px' }}
                        className=" row justify-content-around mx-4 mb-5  mb-lg-4"
                      >
                        <button
                          type="submit"
                          style={{ fontWeight: 'bold' }}
                          className="btn btn-sm m-2 col-xl-7 col-sm-12  btn-primary  rounded-pill "
                        >
                          Reset Password
                        </button>
                      </div>
