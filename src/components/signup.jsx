                                           ...
                                           <form className="mx-1 mx-md-4" onSubmit={handleSubmit}>
                                                <div className="d-flex flex-row align-items-center mb-2">
                                                    ...
                                                    <div className="form-outline flex-fill mb-0">
                                                        <input name="firstname" type="text" className=" form-control border-top-0 border-left-0 border-right-0" placeholder="First Name" onChange={(e) => { formdata(e) }} required ></input>
                                                ...
                                                <div className="d-flex flex-row align-items-center mb-2">
                                                    <i className="fa fa-user fa-lg me-3 fa-fw"></i>
                                                    <div className="form-outline flex-fill mb-0">
                                                        <input name="lastname" type="text" className=" form-control border-top-0 border-left-0 border-right-0 " placeholder="Last Name" onChange={(e) => { formdata(e) }} required></input>
                                                  ...
                                                  <div className="d-flex flex-row align-items-center mb-2">
                                                    ...
                                                    <div className="form-outline flex-fill mb-0">
                                                     ...
                                                     <i onClick={() => { setShowpassword(!showpassword) }} className="d-inline fa fa-eye "></i>
                                                       </div>
                                            ...
                                            <p className="text-center h5 mt-5 mx-1 mx-md-5 mb-4 ">Have an account?<Link to="/login">Login</Link></p></div>
                                      </div>
                                </div>
                            </div>
                        </div>
