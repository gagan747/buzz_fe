...
export default function Signup() {
    ...
    const handleSubmit = (e) => {
        ...
        if (!state.password || !/(?=.*[A-Z])(?=.*[a-z])(?=.*[0-9])(?=.*[!@#%])/.test(state.password))
                                            ...
                                            <form className="mx-1 mx-md-4" onSubmit={handleSubmit}>
                                                ...
                                                <div className="d-flex flex-row align-items-center mb-2">
                                                    ...
                                                    <div className="form-outline flex-fill mb-0">
                                                        <input name="firstname" type="text" className=" form-control border-top-0 border-left-0 border-right-0" placeholder="First Name" onChange={(e) => { dataentry(e) }} required ></input>
                                                ...
                                                <div className="d-flex flex-row align-items-center mb-2">
                                                    <i className="fa fa-user fa-lg me-3 fa-fw"></i>
                                                    <div className="form-outline flex-fill mb-0">
                                                        <input name="lastname" type="text" className=" form-control border-top-0 border-left-0 border-right-0 " placeholder="Last Name" onChange={(e) => { dataentry(e) }} required></input>
                                                ...
                                                <div className="d-flex flex-row align-items-center mb-2">
                                                    ...
                                                    <div className="form-outline flex-fill mb-0">
                                                        <input name="email" type="email" className="form-control border-top-0 border-left-0 border-right-0" placeholder="Email" onChange={(e) => { dataentry(e) }} required />
                                                ...
                                                <div className="d-flex flex-row align-items-center mb-2">
                                                    ...
                                                    <div className="form-outline flex-fill mb-0">
                                                        <input name="password" type={showpassword ? "text" : "password"} id="form3Example4c" style={{ boxShadow: "none" }} className=" form-control border-top-0 border-left-0 border-right-0" placeholder="password" onChange={(e) => { dataentry(e) }} required />

                                                    </div> <i onClick={() => { setShowpassword(!showpassword) }} className="d-inline fa fa-eye "></i>
                                                ...
                                                <div className="d-flex flex-row align-items-center mb-2">
                                                    <i className="fa fa-flag fa-lg me-3 fa-fw"></i>
                                                    <div className="form-outline flex-fill mb-0">
                                                        <input name="country" type="text" id="form3Example1c" style={{ boxShadow: "none" }} className="form-control border-top-0 border-left-0 border-right-0" placeholder="Country" onChange={(e) => { dataentry(e) }} required />

                                                    </div>
                                                </div>
                                                <div className="d-flex flex-row align-items-center mb-2">
                                                    <i className="fa fa-circle fa-lg me-3 fa-fw"></i>
                                                    <div className="form-outline flex-fill mb-0">
                                                        <input name="state" type="text" className="form-control border-top-0 border-left-0 border-right-0" placeholder="State" onChange={(e) => { dataentry(e) }} required />
                                                ...
                                                <div className="d-flex flex-row align-items-center mb-2">
                                                    ...
                                                    <div className="form-outline flex-fill mb-0">
                                                        <input name="city" type="text" className="form-control border-top-0 border-left-0 border-right-0" placeholder="City" onChange={(e) => { dataentry(e) }} required />

                                                    </div>
                                                </div>
                                                <div className="d-flex flex-row align-items-center mb-2 mx-sm-4">
                                                    <div className="form-outline flex-fill mb-0 ">
                                                        <input name="dob" type="date" className="form-control border-top-0 border-left-0 border-right-0" onChange={(e) => { dataentry(e) }} required />
                                                ...
                                                <div className="mb-4 ml-2 mt-3 ml-4 ">
                                                    ...
                                                    <div className="form-check form-check-inline  " >
                                                        ...
                                                        <input className="form-check-input" type="radio" name="gender" id="inlineRadio1" value="Male" onChange={(e) => { dataentry(e) }} required />
                                                        <label className="form-check-label" htmlFor="inlineRadio1">Male</label>
                                                    </div>

                                                    <div className="form-check form-check-inline ">
                                                        <input className="form-check-input" type="radio" name="gender" id="inlineRadio2" value="Female" onChange={(e) => { dataentry(e) }} />
                                                        <label className="form-check-label" htmlFor="inlineRadio2">Female</label>
                                                    </div>

                                                    <div class="form-check form-check-inline ">
                                                        <input className="form-check-input" type="radio" name="gender" id="inlineRadio3" value="Other" onChange={(e) => { dataentry(e) }} />
